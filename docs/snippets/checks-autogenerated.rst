...
.. AUTOGENERATED START: check-ai-accuracy
.. This section is automatically generated by `./manage.py list_checks`. Do not edit manually.
...
:Summary: The evaluation detected a change in meaning.
:Scope: translated strings
:Check class: ``weblate.checks.ai.AIAccuracyCheck``
:Check identifier: ``ai_accuracy``
:Trigger: This check is always enabled but can be ignored using a flag.
:Flag to ignore: ``ignore-ai-accuracy``

.. AUTOGENERATED END: check-ai-accuracy

This check is populated only when the
:ref:`AI quality evaluation add-on <addon-weblate.ai.quality>` runs.
Regular quality check processing does not trigger AI evaluation.

.. AUTOGENERATED START: check-ai-fluency
.. This section is automatically generated by `./manage.py list_checks`. Do not edit manually.
...
:Summary: The evaluation detected a language quality issue.
:Scope: translated strings
:Check class: ``weblate.checks.ai.AIFluencyCheck``
:Check identifier: ``ai_fluency``
:Trigger: This check is always enabled but can be ignored using a flag.
:Flag to ignore: ``ignore-ai-fluency``

.. AUTOGENERATED END: check-ai-fluency

This check is populated only when the
:ref:`AI quality evaluation add-on <addon-weblate.ai.quality>` runs.
Regular quality check processing does not trigger AI evaluation.

.. AUTOGENERATED START: check-ai-formatting
.. This section is automatically generated by `./manage.py list_checks`. Do not edit manually.

.. _check-ai-formatting:

AI: Formatting
~~~~~~~~~~~~~~

:Summary: The evaluation detected a formatting or placeholder issue.
:Scope: translated strings
:Check class: ``weblate.checks.ai.AIFormattingCheck``
:Check identifier: ``ai_formatting``
:Trigger: This check is always enabled but can be ignored using a flag.
:Flag to ignore: ``ignore-ai-formatting``

.. AUTOGENERATED END: check-ai-formatting

This check is populated only when the
:ref:`AI quality evaluation add-on <addon-weblate.ai.quality>` runs.
Regular quality check processing does not trigger AI evaluation.

.. AUTOGENERATED START: check-ai-style
.. This section is automatically generated by `./manage.py list_checks`. Do not edit manually.
...
:Summary: The evaluation detected a style or instruction mismatch.
:Scope: translated strings
:Check class: ``weblate.checks.ai.AIStyleCheck``
:Check identifier: ``ai_style``
:Trigger: This check is always enabled but can be ignored using a flag.
:Flag to ignore: ``ignore-ai-style``

.. AUTOGENERATED END: check-ai-style

This check is populated only when the
:ref:`AI quality evaluation add-on <addon-weblate.ai.quality>` runs.
Regular quality check processing does not trigger AI evaluation.

.. AUTOGENERATED START: check-ai-terminology
.. This section is automatically generated by `./manage.py list_checks`. Do not edit manually.

.. _check-ai-terminology:

AI: Terminology
~~~~~~~~~~~~~~~

:Summary: The evaluation detected incorrect terminology.
:Scope: translated strings
:Check class: ``weblate.checks.ai.AITerminologyCheck``
:Check identifier: ``ai_terminology``
:Trigger: This check is always enabled but can be ignored using a flag.
:Flag to ignore: ``ignore-ai-terminology``

.. AUTOGENERATED END: check-ai-terminology
...
.. seealso::
   ...
   * :ref:`check-formats`
   * `Laravel translation formatting <https://laravel.com/framework/docs/localization#replacing-parameters-in-translation-strings>`_
...
This only checks the amount of translation characters.
...
.. hint::
   ...
   This check looks at number of characters, which might not be the best metric when
