...
:Configuration: +---------------------------+-----------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
                | ``match``                 | Regular expression to match translation files against           | The regular expression must define a named group for component. Also define a named group for language when matching translation files. When creating components from a monolingual base or new base file, omit language and match that source file instead. |
                +---------------------------+-----------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
