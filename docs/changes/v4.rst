...
* Improved Sentry performance monitoring integration.
...
* Added support for :ref:`code-hosting-gitea-pull-requests`.
...
* Fixed :ref:`code-hosting-gerrit` integration to better handle corner cases.
...
* Allow to make :ref:`check-same` avoid the built-in words exceptions.
