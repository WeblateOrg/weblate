...
6. Create a user-writable directory where Weblate can remotely set up the Borg translation backup repository, for example in the home directory (i.e. ``/home/borg/backups``)
