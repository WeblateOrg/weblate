...
|                              +----------------------------------------------------+---------------------------------------+
|                              | Perform automatic translation for component        | :guilabel:`Administration`            |
|                              |                                                    +---------------------------------------+
...
|                              +----------------------------------------------------+---------------------------------------+
|                              | Perform automatic translation for project language | :guilabel:`Administration`            |
|                              |                                                    +---------------------------------------+
|                              |                                                    | :guilabel:`Automatic translation`     |
+------------------------------+----------------------------------------------------+---------------------------------------+
...
.. list-table::
   ...
   * - `Administration`
     - * :guilabel:`Post announcements`
       ...
       * :guilabel:`Perform automatic translation for component`
       ...
       * :guilabel:`Perform automatic translation for project language`
