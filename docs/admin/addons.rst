...
:Configuration: +-----------------+------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
                | ``mode``        | Automatic translation mode   | Available choices: ``suggest`` (Add as suggestion), ``translate`` (Add as translation), ``fuzzy`` (Add as needing edit)                                                                                           |
                +-----------------+------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
                | ``filter_type`` | Search filter                | Available choices: ``all`` (All strings), ``nottranslated`` (Not translated strings), ``todo`` (Strings needing action), ``fuzzy`` (Strings marked for edit), ``check:inconsistent`` (Failed check: Inconsistent) |
                +-----------------+------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
                | ``auto_source`` | Automatic translation source | Available choices: ``others`` (Other translation components), ``mt`` (Machine translation)                                                                                                                        |
                +-----------------+------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
