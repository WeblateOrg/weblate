...
* :ref:`addon-weblate.gettext.xgettext` and :ref:`addon-weblate.gettext.meson` can now keep source locations in generated POT files even when translated PO files omit locations.
