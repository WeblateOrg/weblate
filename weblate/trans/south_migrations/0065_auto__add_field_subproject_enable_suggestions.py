...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProject.enable_suggestions'
        db.add_column(u'trans_subproject', 'enable_suggestions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProject.enable_suggestions'
        db.delete_column(u'trans_subproject', 'enable_suggestions')
