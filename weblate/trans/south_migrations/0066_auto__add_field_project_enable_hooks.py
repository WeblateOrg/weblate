...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.enable_hooks'
        db.add_column(u'trans_project', 'enable_hooks',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.enable_hooks'
        db.delete_column(u'trans_project', 'enable_hooks')
