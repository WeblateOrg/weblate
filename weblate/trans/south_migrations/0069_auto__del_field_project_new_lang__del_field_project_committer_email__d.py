...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'trans_project', 'new_lang')

        # Deleting field 'Project.committer_email'
        db.delete_column(u'trans_project', 'committer_email')
        ...
        db.delete_column(u'trans_project', 'merge_style')

        # Deleting field 'Project.commit_message'
        db.delete_column(u'trans_project', 'commit_message')

        # Deleting field 'Project.committer_name'
        db.delete_column(u'trans_project', 'committer_name')


    def backwards(self, orm):
        # Adding field 'Project.new_lang'
        db.add_column(u'trans_project', 'new_lang',
                      self.gf('django.db.models.fields.CharField')(default='contact', max_length=10),
                      keep_default=False)

        # Adding field 'Project.committer_email'
        db.add_column(u'trans_project', 'committer_email',
        ...
        db.add_column(u'trans_project', 'committer_name',
