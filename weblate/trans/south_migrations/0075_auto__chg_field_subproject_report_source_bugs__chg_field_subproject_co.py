...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubProject.report_source_bugs'
        db.alter_column(u'trans_subproject', 'report_source_bugs', self.gf('django.db.models.fields.EmailField')(max_length=254))

        # Changing field 'SubProject.committer_email'
        db.alter_column(u'trans_subproject', 'committer_email', self.gf('django.db.models.fields.EmailField')(max_length=254))

        # Changing field 'Project.mail'
        db.alter_column(u'trans_project', 'mail', self.gf('django.db.models.fields.EmailField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'SubProject.report_source_bugs'
        db.alter_column(u'trans_subproject', 'report_source_bugs', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'SubProject.committer_email'
        db.alter_column(u'trans_subproject', 'committer_email', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'Project.mail'
        db.alter_column(u'trans_project', 'mail', self.gf('django.db.models.fields.EmailField')(max_length=75))
    ...
    models = {
        ...
        'trans.subproject': {
            ...
            'committer_email': ('django.db.models.fields.EmailField', [], {'default': "'noreply@weblate.org'", 'max_length': '254'}),
            ...
            'report_source_bugs': ('django.db.models.fields.EmailField', [], {'max_length': '254', 'blank': 'True'}),
