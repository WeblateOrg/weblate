...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Translation.have_comment'
        db.add_column(u'trans_translation', 'have_comment',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Translation.have_comment'
        db.delete_column(u'trans_translation', 'have_comment')
    ...
    models = {
        ...
        'trans.subproject': {
            ...
            'vcs': ('django.db.models.fields.CharField', [], {'default': "'git'", 'max_length': '20'})
        },
        'trans.suggestion': {
        ...
        'trans.translation': {
            ...
            'have_comment': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
