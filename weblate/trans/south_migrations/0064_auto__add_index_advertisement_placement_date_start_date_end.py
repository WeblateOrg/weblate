...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Advertisement', fields ['placement', 'date_start', 'date_end']
        db.create_index(u'trans_advertisement', ['placement', 'date_start', 'date_end'])


    def backwards(self, orm):
        # Removing index on 'Advertisement', fields ['placement', 'date_start', 'date_end']
        db.delete_index(u'trans_advertisement', ['placement', 'date_start', 'date_end'])
