...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProject.vcs'
        db.add_column(u'trans_subproject', 'vcs',
                      self.gf('django.db.models.fields.CharField')(default='git', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProject.vcs'
        db.delete_column(u'trans_subproject', 'vcs')
