...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                django.contrib.postgres.indexes.OpClass(
                    models.F("target"), name="gin_trgm_ops"
                ),
                models.F("translation"),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                django.contrib.postgres.indexes.OpClass(
                    models.F("context"), name="gin_trgm_ops"
                ),
                models.F("translation"),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                django.contrib.postgres.indexes.OpClass(
                    models.F("note"), name="gin_trgm_ops"
                ),
                models.F("translation"),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                django.contrib.postgres.indexes.OpClass(
                    models.F("location"), name="gin_trgm_ops"
                ),
                models.F("translation"),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                django.contrib.postgres.indexes.OpClass(
                    models.F("explanation"), name="gin_trgm_ops"
                ),
                models.F("translation"),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                django.contrib.postgres.indexes.OpClass(
                    models.F("comment"), name="gin_trgm_ops"
                ),
                models.F("unit"),
