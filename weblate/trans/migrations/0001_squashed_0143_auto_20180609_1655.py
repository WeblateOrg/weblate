    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_source_bugs', models.EmailField(blank=True, help_text='Email address errors in source strings will be reported to. Keep empty for no emails.', max_length=254, verbose_name='Source string bug reporting address')),
                ...
                ('file_format', models.CharField(choices=FILE_FORMATS.get_choices(), default='auto', help_text='Automatic detection might fail for some formats and is slightly slower.', max_length=50, verbose_name='Fileformat')),
