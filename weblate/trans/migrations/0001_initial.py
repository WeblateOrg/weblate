    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(related_name='author_set', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.CASCADE)),
            ],
            options={
                'ordering': ['-timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_lang', models.CharField(default='contact', help_text='How to handle requests for creating new languages.', max_length=10, verbose_name='New language', choices=[('contact', 'Use contact form'), ('url', 'Point to translation instructions URL'), ('add', 'Automatically add language file'), ('none', 'No adding of language')])),
                ('merge_style', models.CharField(default='merge', help_text='Define whether Weblate should merge upstream repository or rebase changes onto it.', max_length=10, verbose_name='Merge style', choices=[('merge', 'Merge'), ('rebase', 'Rebase')])),
                ('commit_message', models.TextField(default='Translated using Weblate (%(language_name)s)\n\nCurrently translated at %(translated_percent)s%% (%(translated)s of %(total)s strings)', help_text='You can use format strings for various information, please check documentation for more details.', verbose_name='Commit message', validators=[weblate.utils.validators.validate_render])),
                ('committer_name', models.CharField(default='Weblate', max_length=200, verbose_name='Committer name')),
                ('committer_email', models.EmailField(default='noreply@weblate.org', max_length=75, verbose_name='Committer email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_commit_file', models.CharField(default='', max_length=200, blank=True, help_text='Additional file to include in commits; please check documentation for more details.', verbose_name='Additional commit file')),
                ...
                ('check_flags', models.TextField(default='', help_text='Additional comma-separated flags to influence quality checks, check documentation for possible values.', blank=True, verbose_name='Quality checks flags', validators=[weblate.trans.validators.validate_check_flags])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('revision', models.CharField(default='', max_length=100, blank=True)),
