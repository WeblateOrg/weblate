...
class ProjectAPITest(APIBaseTest):
    ...
    def test_repo_status_filters_inaccessible_repositories(self) -> None:
        ...
        self.assertEqual(
            response.data["skipped_components"], [self.component.full_slug]
        )
        self.assertEqual(response.data["permission_blockers"], [linked.full_slug])
    ...
    def test_repo_operation_filters_inaccessible_repositories(self) -> None:
        ...
        self.assertEqual(
            response.data,
            {
                ...
                "permission_blockers": [linked.full_slug],
            },
        )
