...
def migrate_editor(apps, schema_editor):
    ...
    for profile in Profile.objects.exclude(editor_link=''):
        profile.editor_link = weblate.utils.render.migrate_repoweb(
            profile.editor_link
        )
        profile.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='profile',
            name='editor_link',
            field=models.CharField(blank=True, default='', help_text='Enter custom URL to be used as link to open source code. You can use {{branch}} for branch, {{filename}} and  {{line}} as filename and line placeholders. Usually something like editor://open/?file={{filename}}&line={{line}} is good option.', max_length=200, validators=[weblate.utils.render.validate_editor], verbose_name='Editor link'),
        ),
