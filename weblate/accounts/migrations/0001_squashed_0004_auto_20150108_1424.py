    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', models.ManyToManyField(blank=True, to=b'lang.Language', verbose_name='Languages')),
                ('secondary_languages', models.ManyToManyField(blank=True, related_name=b'secondary_profile_set', to=b'lang.Language', verbose_name='Secondary languages')),
                ('subscriptions', models.ManyToManyField(blank=True, to=b'trans.Project', verbose_name='Subscribed projects')),
