    ...
    @extend_schema(
        ...
        description=(
            ...
            + (
                ...
                "Hourly maintenance retires publications when the component becomes incompatible; "
                "the normal artifact retention window still applies. "
                ...
                "Cache manifests for at most one hour (Cache-Control: public, max-age=3600). "
                "Translation updates and retirements can take up to one hour to reach clients; "
                "use Cache-Control: no-cache when immediate revalidation is preferred. "
