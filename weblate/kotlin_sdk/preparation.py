...
if TYPE_CHECKING:
    ...
    from weblate.kotlin_sdk.arsc import ResourceTable, ResourceValue
...
def prepare(
    ...
    compile_locale: Callable[[str, str, ResourceTable], bytes],
    ...
    for language, (locale, entries) in translations(keys):
        ...
        if not resources:
            continue
        content = compile_locale(mapping["packageName"], locale, resources)
        del resources
