...
var _track_id = 1;
var _track_params = JSON.parse(document.getElementById("matomo-tracker").dataset.params);
...
(function() {
    ...
    g.type='text/javascript'; g.async=true; g.defer=true; g.src='{{ matomo_url|escapejs }}matomo.js'; s.parentNode.insertBefore(g,s);
})();
