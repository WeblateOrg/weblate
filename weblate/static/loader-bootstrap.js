...
$(function () {
    ...
    /* Support form */
    if (typeof $.prototype.ZammadForm !== 'undefined') {
      $('#support-form').ZammadForm({
        messageTitle: gettext('Weblate feedback'),
        messageSubmit: gettext("Get help"),
        messageThankYou: gettext('Thank you for your inquiry (#%s)! We\'ll contact you as soon as possible.'),
        showTitle: true,
        modal: true,
        ...
        attributes: [
          ...
          },
          {
            ...
            name: 'body',
            tag: 'textarea',
            placeholder: gettext("Please contact us in English, otherwise we might be unable to process your request."),
            defaultValue: '',
            rows: 7,
          },
          {
