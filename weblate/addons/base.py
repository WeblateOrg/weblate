...
class BaseAddon:
    ...
    def create_object(
        ...
        **kwargs,
        ...
        result = Addon(project=project, component=component, name=cls.name, **kwargs)
    ...
    def create(
        ...
        **kwargs,
        ...
        storage = cls.create_object(component=component, project=project, **kwargs)
    ...
    def get_add_form(
        ...
        **kwargs,
        ...
        if cls.settings_form is None:
            return None
        storage = cls.create_object(component=component, project=project)
