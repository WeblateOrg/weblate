...
SOCIAL_AUTH_GITHUB_ENTERPRISE_KEY = os.environ.get("WEBLATE_SOCIAL_AUTH_GITHUB_ENTERPRISE_KEY", "")
SOCIAL_AUTH_GITHUB_ENTERPRISE_SECRET = os.environ.get("WEBLATE_SOCIAL_AUTH_GITHUB_ENTERPRISE_SECRET", "")
SOCIAL_AUTH_GITHUB_ENTERPRISE_URL = os.environ.get("WEBLATE_SOCIAL_AUTH_GITHUB_ENTERPRISE_URL", "")
SOCIAL_AUTH_GITHUB_ENTERPRISE_API_URL = os.environ.get("WEBLATE_SOCIAL_AUTH_GITHUB_ENTERPRISE_API_URL", "")
SOCIAL_AUTH_GITHUB_ENTERPRISE_SCOPE = os.environ.get("WEBLATE_SOCIAL_AUTH_GITHUB_ENTERPRISE_SCOPE", "")
if "WEBLATE_SOCIAL_AUTH_GITHUB_ENTERPRISE_KEY" in os.environ:
    AUTHENTICATION_BACKENDS += ("social_core.backends.github_enterprise.GithubEnterpriseOAuth2",)
