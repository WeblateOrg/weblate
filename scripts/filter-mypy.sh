...
grep -vE '"Field" has no attribute "(choices|queryset|name)"|.Settings. object has no attribute|/test.* has incompatible type "Mock[A-Za-z]*"; expected "(Unit|Check)"|/test.*has incompatible type "None"; expected "Unit"'
